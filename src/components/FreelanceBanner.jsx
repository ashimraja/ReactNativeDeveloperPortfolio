...
export default function FreelanceBanner(){
  return (
    <motion.section initial={{ scale: 0.98, opacity: 0.9 }} whileInView={{ scale:1, opacity:1 }} className="my-12 py-6 px-6 rounded-2xl bg-gradient-to-r from-slate-900 to-slate-800 text-white max-w-4xl mx-auto">
